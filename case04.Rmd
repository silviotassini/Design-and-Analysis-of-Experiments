...
Em uma primeira análise dos dados buscou-se verificar se existia uma diferença significativa das médias entre os *Risers*.
...
##Conclusão
Concluindo a análise estatística o pesquisador não obteve  evidências que permitissem escolher um *Riser* em detrimento de outro. Não foram detectads diferenças siginificantes entre as médias dos tempo de falha entre os  quatro métodos. Destaca que a desigualdade de variâncias entre as amostras coletadas em cada Riser apontada pelo teste *Fligner-Killeen* tem seu efeito negativo reduzido devido ao tamanho amostral dos grupos serem iguais.
