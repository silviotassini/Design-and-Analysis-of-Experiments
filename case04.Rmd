...
Considerando as especificaçõeses do pesquisador, tais como poder de teste superior a 80% e nível de significancia igual a 5%, foi calculado a necessidade de `r power$n` observaçoes em cada novo *Riser*. Isto implica um custo adicional de `r power$n`.
