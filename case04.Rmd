...
Considerando as especificaçõeses do pesquisador, tais como poder de teste superior a 80% e nível de significancia igual a 5%, foi calculado a necessidade de `r ceil(power$n)` observaçoes em cada novo *Riser*. Isto implica um custo adicional de `r power$n * 25000`.
...
```
Verificando a mario e menor variância é preciso que se teste se a variancia maior é significativamente diferente da variancia menor. Se não for o caso então nenhuma das variancias é significantemnte diferente das outras.
