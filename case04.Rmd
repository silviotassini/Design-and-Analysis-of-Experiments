...
## Análise Estatítica
Foi realizado um teste estatístico *F* que forneceu  um *p-valor* de $`r round(t$p.value,4)`$ indicador que, para um nível de confiança de `r (1-alpha)*100`%, a hipótese nula não pode ser rejeitada.
